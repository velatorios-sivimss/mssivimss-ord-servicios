...
public class ReglasNegocioConsultaODSRepository {
	...
	private String queryODSPreOrden(ReporteDto reporteDto) {
		String str= queryCamposConsultaODS() 
				...
				+ JOIN + " SVC_CARACTERISTICAS_PRESUPUESTO_TEMP scp2 ON  scp2.ID_ORDEN_SERVICIO = sos.ID_ORDEN_SERVICIO "
				...
				+ LEFT_JOIN + " SVC_DETALLE_CARACTERISTICAS_PRESUPUESTO_TEMP sdcp ON scp2.ID_CARACTERISTICAS_PRESUPUESTO = sdcp.ID_CARACTERISTICAS_PRESUPUESTO  "
