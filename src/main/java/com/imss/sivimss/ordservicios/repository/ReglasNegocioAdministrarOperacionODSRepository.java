...
public class ReglasNegocioAdministrarOperacionODSRepository {
	...
	public String consultarContratanteFinado(String folio,Integer idVelatorio) {
		...
		selectQueryUtilOrdenes.select(
				"DISTINCT CONCAT(SPC.NOM_PERSONA,' ', SPC.NOM_PRIMER_APELLIDO, ' ', SPC.NOM_SEGUNDO_APELLIDO) AS contratante",
				"CONCAT(SPF.NOM_PERSONA,' ', SPF.NOM_PRIMER_APELLIDO, ' ', SPF.NOM_SEGUNDO_APELLIDO) AS finado"
				)
