...
public class ReglasNegocioGeneraReporteODSRepository {
	...
	public String generaReporteODSCU025(ReporteDto reporteDto) {
		String query ="SELECT DISTINCT(sos.ID_ORDEN_SERVICIO) "
				...
				+ ",CONCAT('$ ' ,IFNULL(FORMAT((SELECT SUM (sdcp1.IMP_CARAC_PRESUP) FROM SVC_DETALLE_CARACTERISTICAS_PRESUPUESTO sdcp1 WHERE sdcp1.ID_CARACTERISTICAS_PRESUPUESTO = scp.ID_CARACTERISTICAS_PRESUPUESTO "
