...
public class ReglasNegocioRepository {
	...
	public String consultarCaracteristicasPresupuestoDetallePaqueteTempOrdenServicios(Integer idCaracteristicasPaquete) {
						...
						.from("SVC_DETALLE_CARACTERISTICAS_PAQUETE_TEMP SDCPT ")
						.innerJoin("SVC_CARACTERISTICAS_PAQUETE_TEMP SCP ", "SCP.ID_CARACTERISTICAS_PAQUETE = SDCPT.ID_CATEGORIA_PAQUETE  ")
						.leftJoin("SVT_ARTICULO STA", "STA.ID_ARTICULO = SDCPT.ID_ARTICULO ")
						.leftJoin("SVC_CATEGORIA_ARTICULO SCA", "SCA.ID_CATEGORIA_ARTICULO = SDCPT.ID_CATEGORIA_ARTICULO ")
						.leftJoin("SVT_PROVEEDOR SP", "SP.ID_PROVEEDOR = SDCPT.ID_PROVEEDOR  ")
						.where("SDCPT.ID_CARACTERISTICAS_PAQUETE = " + idCaracteristicasPaquete)
