...
public class ContratoPF {
	...
	public String consultarContratantesBeneficiarios(ContratoPfRequest contratoPfRequest){
		...
		.from("SVT_CONVENIO_PF STC")
		.innerJoin("SVT_CONTRA_PAQ_CONVENIO_PF CPA", "CPA.ID_CONVENIO_PF = STC.ID_CONVENIO_PF")
		.innerJoin("SVT_CONTRATANTE_BENEFICIARIOS SCB", "SCB.ID_CONTRA_PAQ_CONVENIO_PF= CPA.ID_CONTRA_PAQ_CONVENIO_PF  ")
