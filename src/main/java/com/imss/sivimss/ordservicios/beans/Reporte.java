...
public class Reporte {
	...
	public String consultarReporteSalidaDonacion(Integer idOrdenServicio) {
		...
		.innerJoin("SVC_DETALLE_CARAC_PRESUP SDCPT", "SDCPT.ID_CARACTERISTICAS_PRESUPUESTO = SCPT.ID_CARACTERISTICAS_PRESUPUESTO").and("SDCPT.IND_ACTIVO = 1")
	...
	public String consultarReporteSalidaDonacionTemp(Integer idOrdenServicio) {
		...
		.innerJoin("SVC_DETALLE_CARAC_PRESUP_TEMP SDCPT", "SDCPT.ID_CARACTERISTICAS_PRESUPUESTO = SCPT.ID_CARACTERISTICAS_PRESUPUESTO").and("SDCPT.IND_ACTIVO = 1")
