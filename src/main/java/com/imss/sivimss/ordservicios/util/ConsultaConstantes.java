...
public class ConsultaConstantes {
	...
	public static final String CONCAT_WS_SU_NOM_USUARIO_SU_NOM_APELLIDO_PATERNO_SU_NOM_APELLIDO_MATERNO_AS_NOM_ADMINISTRADOR = "CONCAT_WS(' ',PE.NOM_PERSONA,PE.NOM_PRIMER_APELLIDO,PE.NOM_SEGUNDO_APELLIDO) AS nomAdministrador";
