...
public class PromotorController {
	...
	public CompletableFuture<Object> consultarPromotores(@RequestBody DatosRequest request, Authentication authentication) throws IOException{
		Response<?>response=promotorService.consultarPromotores(request, authentication);
