...
public class CodigoPostalController {
	...
	public CompletableFuture<?> buscarCodigoPostal(@RequestBody DatosRequest request, Authentication authentication) throws IOException{
		Response<?>response=codigoPostalService.buscarCodigoPostal(request, authentication);
